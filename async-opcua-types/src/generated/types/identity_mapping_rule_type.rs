...
impl opcua::types::BinaryEncodable for IdentityMappingRuleType {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        let mut size = 0usize;
        size += opcua::types::BinaryEncodable::byte_len(&self.criteria_type, ctx);
        size += opcua::types::BinaryEncodable::byte_len(&self.criteria, ctx);
        size
    }
    #[allow(unused)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        opcua::types::BinaryEncodable::encode(&self.criteria_type, stream, ctx)?;
        opcua::types::BinaryEncodable::encode(&self.criteria, stream, ctx)?;
        Ok(())
    }
}
