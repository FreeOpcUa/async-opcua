...
impl opcua::types::BinaryEncodable for ProgramDiagnostic2DataType {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += opcua::types::BinaryEncodable::byte_len(&self.last_method_input_values, ctx);
        size += opcua::types::BinaryEncodable::byte_len(&self.last_method_output_values, ctx);
    ...
    fn encode<S: std::io::Write + ?Sized>(
        ...
        opcua::types::BinaryEncodable::encode(&self.last_method_input_values, stream, ctx)?;
        opcua::types::BinaryEncodable::encode(&self.last_method_output_values, stream, ctx)?;
