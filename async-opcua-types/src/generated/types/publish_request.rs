...
impl opcua::types::BinaryEncodable for PublishRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += opcua::types::BinaryEncodable::byte_len(&self.subscription_acknowledgements, ctx);
        size
    }
    #[allow(unused)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        opcua::types::BinaryEncodable::encode(&self.subscription_acknowledgements, stream, ctx)?;
        Ok(())
    }
}
