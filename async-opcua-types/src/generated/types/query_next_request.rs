...
impl opcua::types::BinaryEncodable for QueryNextRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += opcua::types::BinaryEncodable::byte_len(&self.release_continuation_point, ctx);
    ...
    fn encode<S: std::io::Write + ?Sized>(
        ...
        opcua::types::BinaryEncodable::encode(&self.release_continuation_point, stream, ctx)?;
