...
impl opcua::types::BinaryEncodable for RegisterServer2Response {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += opcua::types::BinaryEncodable::byte_len(&self.configuration_results, ctx);
    ...
    fn encode<S: std::io::Write + ?Sized>(
        ...
        opcua::types::BinaryEncodable::encode(&self.configuration_results, stream, ctx)?;
...
unsafe impl Send for RegisterServer2Response
where
...
unsafe impl Sync for RegisterServer2Response
where
