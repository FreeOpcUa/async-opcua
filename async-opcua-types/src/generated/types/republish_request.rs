...
impl opcua::types::BinaryEncodable for RepublishRequest {
    ...
    fn byte_len(&self, ctx: &opcua::types::Context<'_>) -> usize {
        ...
        size += opcua::types::BinaryEncodable::byte_len(&self.retransmit_sequence_number, ctx);
        size
    }
    #[allow(unused)]
    fn encode<S: std::io::Write + ?Sized>(
        ...
        opcua::types::BinaryEncodable::encode(&self.retransmit_sequence_number, stream, ctx)?;
        Ok(())
    }
}
