...
- **SC-004**: Steady-state per-request (small read) and per-publish allocation is **measurably reduced** versus the pre-feature baseline, with before/after numbers recorded.
